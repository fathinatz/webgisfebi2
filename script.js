...
$.getJSON("asset/data-spasial/jembatan_pt copy.geojson", function (data) {
    ...
    jembatanPT.addTo(map); // Tambahkan layer ke peta setelah data dimuat
});
    ...
    L.geoJSON(data, {
        style: function(feature) {
            switch (feature.properties.REMARK) {
                ...
                case 'Sawah':
                    return { fillColor: "#a4faa0", fillOpacity: 0.8, weight: 0.5, color: "#4065EB" };
                case 'Semak Belukar':
                    return { fillColor: "#A69e64", fillOpacity: 0.8, weight: 0.5, color: "#00A52F" };
                case 'Tanah Kosong/Gundul':
                    return { fillColor: "#D3D3D3", fillOpacity: 0.8, weight: 0.5, color: "#000000" };
                case 'Tegalan/Ladang':
...
// Tambahkan layer ke peta setelah data dimuat
landcover.addTo(map);
